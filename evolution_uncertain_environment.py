...
# Introducing uncertainty into the environment
...
print("Hello Arthur, Welcome to my simulation. For your ease of use, I have created a small list of instructions \n"
      ...
      "7. The parameter B which denotes the environment (in here it is uncertain)\n"
...
run.simulation(30, 6, 10, 40, 0.6, 0.01, B, c)
